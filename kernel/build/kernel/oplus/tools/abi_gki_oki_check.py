...
def main():
    ...
    set_env_from_file('kernel/common-5.15/build.config.constants')
    ...
    src_and_targets = [
        ('vendor/aosp_gki/kernel-5.15/aarch64/vmlinux.symvers', 'out/oplus/vmlinux_gki.symvers'),
        ('out_krn/target/product/vnd/obj/KERNEL_OBJ/dist/vmlinux.symvers', 'out/oplus/vmlinux.symvers'),
        ('vendor/aosp_gki/kernel-5.15/aarch64/vmlinux', 'out/oplus/vmlinux'),
        ('kernel/build/kernel/oplus/config/abi_symbols_tmp_approval.csv', 'out/oplus/abi_symbols_tmp_approval.csv'),
    ...
    src_dir_list = [
        pathlib.Path("out_krn/target/product/vnd/symbols/kernel-5.15/system/lib/modules"),
    ]
