...
static int sc96257_set_fod_parm(struct oplus_chg_ic_dev *dev, u8 data[], int len)
{
	return 0;
}

static int sc96257_send_msg(struct oplus_chg_ic_dev *dev, unsigned char msg[], int len)
{
	struct oplus_sc96257 *chip;
	union ask_pkt_type ask_packet;
	int rc;
