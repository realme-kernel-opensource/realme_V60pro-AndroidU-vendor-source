...
{
	struct cps_wls_chrg_chip *chip = NULL;
	int gp0_val = 0, gp1_val = 0, gp2_val = 0, gp3_val = 0;
	...
	return sprintf(buf, "gp0=%d, gp1=%d, gp2=%d, gp3=%d\n",
		gp0_val, gp1_val, gp2_val, gp3_val);
}
...
void cps8601_init(void)
{
	i2c_add_driver(&cps8601_driver);
}

void cps8601_exit(void)
{
