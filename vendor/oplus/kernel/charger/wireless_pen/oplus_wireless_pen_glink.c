...
static int __init wireless_pen_glink_init(void)
{
	int ret;
...
module_init(wireless_pen_glink_init);

static void __exit wireless_pen_glink_exit(void)
{
	platform_driver_unregister(&wireless_pen_glink_driver);
}
module_exit(wireless_pen_glink_exit);
