    ...
    switch (mode) {
        ...
        case MODE_GESTURE:
            if (flag) {
                ...
                cts_plat_reset_device(cts_data->pdata);		/* For P-sensor, enter gesture mode again */
                msleep(50);
        ...
        struct gesture_info *gesture)
{
  ...
  switch(gesture_info->gesture_id) {
    case CTS_GESTURE_D_TAP:
		gesture_type = DOU_TAP;			break;
    case CTS_GESTURE_V:
		gesture_type = UP_VEE;			break;
    case CTS_GESTURE_M:
		gesture_type = M_GESTRUE;		break;
    case CTS_GESTURE_W:
		gesture_type = W_GESTURE;		break;
    case CTS_GESTURE_O:
		gesture_type = CIRCLE_GESTURE;	break;
    case CTS_GESTURE_RV:
		gesture_type = DOWN_VEE;		break;
    case CTS_GESTURE_DOUBLE:
		gesture_type = DOU_SWIP;		break;
    case CTS_GESTURE_LR:
		gesture_type = RIGHT_VEE;		break;
    case CTS_GESTURE_RR:
		gesture_type = LEFT_VEE;		break;
	case CTS_GESTURE_S_TAP:
		gesture_type = SINGLE_TAP;		break;
    default:
