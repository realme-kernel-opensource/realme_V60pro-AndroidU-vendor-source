...
#define AW882XX_DRIVER_VERSION "v0.2.2"
	...
	struct aw882xx *aw882xx)
{
	...
	snprintf(buf, 64, format, *change_name, aw882xx->chan_info.name_suffix);
...
static int aw882xx_probe(aw_snd_soc_codec_t *codec)
{
	...
	/* Hefeng.Wu@RM.MM.AudioDriver.SmartPA, 2020/10/13, delete for save power */
