...
#ifdef OPLUS_ARCH_EXTENDS
/*zhangjiaquan@MULTIMEDIA.AUDIODRIVER.PA, 2023/06/20, set pa type for calibration*/
...
static void oplus_aw882xx_parse_feature_dt(struct aw882xx *aw882xx)
{
	...
	aw_dev_info(aw882xx->dev, "parse dt spin_flag: %d, need_f0_cali:%d ", aw882xx->spin_flag, aw882xx->need_f0_cali);
				...
				loff_t *ppos)
{
	...
	pr_info("%s addr 0x%x, str=%s ret = %d len = %d \n", __func__, aw882xx->i2c->addr, str, ret, len);
	kfree(str);
range_err:
	return ret;
}
...
static const struct file_operations aw882xx_dbgfs_cali_r_impedance_fops = {
	.open = simple_open,
	.read = aw882xx_dbgfs_check_re_show,
	.llseek = default_llseek,
};

static const struct file_operations aw882xx_dbgfs_f0_range_fops = {
	.open = simple_open,
	.read = aw882xx_dbgfs_f0_range_read,
	.llseek = default_llseek,
};

static const struct file_operations aw882xx_dbgfs_f0_show_fops = {
	.open = simple_open,
	.read = aw882xx_dbgfs_cali_f0_show,
	.llseek = default_llseek,
};
				...
				loff_t *ppos)
{
	...
	if (ret <= 0) {
		...
		len += snprintf((char *)&buf+len-1, PAGE_SIZE-len, "\0"); /* -1 delete the last "," */
	}
...
static const struct file_operations aw882xx_cali_pa_cnt_fops = {
	.open = simple_open,
	.read = aw882xx_read_cali_pa_cnt,
	.llseek = default_llseek,
};

static const struct file_operations aw882xx_cali_re_to_bin_fops = {
	.open = simple_open,
	.read = aw882xx_read_cali_re_to_bin,
	.llseek = default_llseek,
};

static const struct file_operations aw882xx_cali_re_to_driver_fops = {
	.open = simple_open,
	.write = aw882xx_write_cali_re_to_driver,
	.llseek = default_llseek,
};

#ifdef AW_NEED_CALIB_F0
static const struct file_operations aw882xx_cali_f0_to_bin_fops = {
	.open = simple_open,
	.read = aw882xx_read_cali_f0_to_bin,
	.llseek = default_llseek,
};

static const struct file_operations aw882xx_cali_f0_to_driver_fops = {
	.open = simple_open,
	.write = aw882xx_write_cali_f0_to_driver,
	.llseek = default_llseek,
};
#endif
...
#ifdef AW_MTK_PLATFORM_WITH_DSP
	//mtk_spk_set_type(MTK_SPK_AWINIC_AW882XX); // type for dsp calibration
#endif
#endif /*OPLUS_ARCH_EXTENDS*/
	return ret;
err_sysfs:
