...
/*Tao.Ban@MULTIMEDIA.AUDIODRIVER.FTM, 2022/01/25, Add for calibration*/
...
#define AW_CALI_f0_DEFAULT_TIMER	(5000)
#else
// Add for aw cali mode
#define AW_CALI_f0_DEFAULT_TIMER	(2000)
#endif /*OPLUS_ARCH_EXTENDS*/
...
#ifdef OPLUS_ARCH_EXTENDS
// Add for aw cali mode
#define AW_CALI_F0_DEFAULT_MAX		(1200)
#define AW_CALI_F0_DEFAULT_MIN		(200)
#endif /*OPLUS_ARCH_EXTENDS*/
...
int aw882xx_cali_read_f0_from_nvram(int32_t *cali_f0, int32_t ch_index);
